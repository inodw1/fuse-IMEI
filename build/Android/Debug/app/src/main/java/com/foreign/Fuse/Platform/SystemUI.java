...
public class SystemUI
{
    ...
    public static float GetDensity86()
    {
        DisplayMetrics m = (DisplayMetrics)com.foreign.Fuse.Platform.SystemUI.GetDisplayMetrics87();
        return m.density;
    }
    
    public static Object GetDisplayMetrics87()
    {
    ...
    public static float GetStatusBarHeight88()
    {
        int result = 0;
        if (ExternedBlockHost.callUno_Fuse_Platform_SystemUI__systemUIStateGet82()==0)
        {
        	...
        	if (result == 0)
        	{
        		if (ExternedBlockHost.callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeGet89())
        		{
        		result = ExternedBlockHost.callUno_Fuse_Platform_SystemUI_cachedOpenSizeGet90();
        		}
        	} else {
        		ExternedBlockHost.callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeSet89(true);
        		ExternedBlockHost.callUno_Fuse_Platform_SystemUI_cachedOpenSizeSet90(result);
        	}
        }
        return (float)result;
    }
    
    public static int GetSuperLayoutHeight91()
    {
    ...
    public static void HookOntoRawActivityEvents92()
    {
        com.fuse.Activity.SubscribeToLifecycleChange(new com.fuse.Activity.ActivityListener()
        {
        	...
        	@Override public void onPause() { com.foreign.Fuse.Platform.SystemUI.OnPause93(); }
        	@Override public void onResume() { com.foreign.Fuse.Platform.SystemUI.OnResume94(); }
        	@Override public void onDestroy() { ExternedBlockHost.callUno_Fuse_Platform_SystemUI_OnDestroy95(); }
        	@Override public void onConfigurationChanged(android.content.res.Configuration config) { ExternedBlockHost.callUno_Fuse_Platform_SystemUI_OnConfigChanged96(); }
        });
    }
    ...
    public static Object MakePostV11LayoutChangeListener76()
    {
        return new OnLayoutChangeListener() {
        	...
        	int lastWidth = (int)ExternedBlockHost.callUno_Fuse_Platform_SystemUI_GetRealDisplayWidth97();
        	...
        	@Override
        		...
        		if (newWidth!=lastWidth || newHeight!=lastHeight) {
        			...
        			lastWidth = newWidth;
        			ExternedBlockHost.callUno_Fuse_Platform_SystemUI_cppOnConfigChanged98();
        			...
        			if (kl!=null) ExternedBlockHost.callUno_Fuse_Platform_SystemUI_ResendFrameSizes99();
        		}
        	}
        };
    }
    
    public static void OnCreate100()
    {
        Activity activity = com.fuse.Activity.getRootActivity();
        ...
        ViewTreeObserver.OnGlobalLayoutListener kl = new ViewTreeObserver.OnGlobalLayoutListener() { public void onGlobalLayout() { com.foreign.Fuse.Platform.SystemUI.unoOnGlobalLayout101(); }};
        ...
        com.foreign.Fuse.Platform.SystemUI.HookOntoRawActivityEvents92();
    }
    
    public static void OnPause93()
    {
        ((FrameLayout)ExternedBlockHost.callUno_Fuse_Platform_SystemUI_RootLayoutGet75()).setVisibility(View.GONE);
    }
    
    public static void OnResume94()
    {
        ExternedBlockHost.callUno_Fuse_Platform_SystemUI_UpdateStatusBar102();
        ((FrameLayout)ExternedBlockHost.callUno_Fuse_Platform_SystemUI_RootLayoutGet75()).setVisibility(View.VISIBLE);
    }
    
    public static void SetAsRootView103(final Object view)
    {
    ...
    public static void ShowStatusBar104()
    {
        com.fuse.Activity.getRootActivity().runOnUiThread(new Runnable() { public void run()
        {
        	...
        	ExternedBlockHost.callUno_Fuse_Platform_SystemUI_CompensateRootLayoutForSystemUI79();
        	ExternedBlockHost.callUno_Fuse_Platform_SystemUI_cppOnTopFrameChanged85((int)(int)com.foreign.Fuse.Platform.SystemUI.GetStatusBarHeight88());
        }});
    }
    
    public static void unoOnGlobalLayout101()
    {
        ...
        heightDiff -= com.foreign.Fuse.Platform.SystemUI.GetStatusBarHeight88();
        ...
        if (heightDiff!=ExternedBlockHost.callUno_Fuse_Platform_SystemUI_lastKeyboardHeightGet105() || ExternedBlockHost.callUno_Fuse_Platform_SystemUI_firstSizingGet106()) {
        	if (keyboardClosed) {
        		ExternedBlockHost.callUno_Fuse_Platform_SystemUI_onHideKeyboard107((int)heightDiff,(boolean)ExternedBlockHost.callUno_Fuse_Platform_SystemUI_firstSizingGet106());
        	} else {
        		ExternedBlockHost.callUno_Fuse_Platform_SystemUI_onShowKeyboard108((int)heightDiff,(boolean)ExternedBlockHost.callUno_Fuse_Platform_SystemUI_firstSizingGet106());
        	}
        }
        ExternedBlockHost.callUno_Fuse_Platform_SystemUI_firstSizingSet106(false);
    }
