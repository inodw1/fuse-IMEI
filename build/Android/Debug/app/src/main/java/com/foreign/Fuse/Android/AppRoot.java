...
public class AppRoot
{
    ...
    public static void ClearRoot1330(final Object handle)
    {
        ((android.widget.FrameLayout)handle).removeAllViews();
    }
    
    public static Object CreateRootView331()
    {
        android.widget.FrameLayout frameLayout = new android.widget.FrameLayout(com.apps.callhistory.CallHistory.GetRootActivity()) {
        		...
        		public boolean onTouchEvent(android.view.MotionEvent motionEvent) {
        			...
        			ExternedBlockHost.callUno_Fuse_Android_AppRoot_OnTouchEvent__332((Object)motionEvent,UnoHelper.GetUnoObjectRef((Object)motionEvent));
    ...
    public static void SetRootView1333(final Object handle,final Object rootHandle)
    {
