...
public class ViewFactory
{
    ...
    public static Object InstantiateViewGroupImpl232()
    {
        android.widget.FrameLayout frameLayout = new com.fuse.android.views.ViewGroup(com.apps.callhistory.CallHistory.GetRootActivity());
