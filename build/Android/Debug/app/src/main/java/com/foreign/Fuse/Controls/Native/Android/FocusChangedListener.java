...
public class FocusChangedListener
{
    ...
    public static void ClearListener120(final Object viewHandle)
    {
        ((android.view.View)viewHandle).setOnFocusChangeListener(null);
    }
    
    public static Object Create121(final UnoObject _this)
    {
        android.view.View.OnFocusChangeListener listener = new android.view.View.OnFocusChangeListener() {
        	public void onFocusChange(android.view.View view, boolean hasFocus) {
        		ExternedBlockHost.callUno_Fuse_Controls_Native_Android_FocusChangedListener_OnFocusChange122((UnoObject)_this,(boolean)hasFocus);
        	}
        };
        return listener;
    }
    
    public static void SetListener123(final Object viewHandle,final Object listenerHandle)
    {
