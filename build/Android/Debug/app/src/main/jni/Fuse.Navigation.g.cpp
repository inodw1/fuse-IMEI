...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\NavigationAnimations.uno
// -------------------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\INavigation.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\SwipeNavigate.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\ModifyRouteCommand.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\Router.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\TriggerActions.uno
// -------------------------------------------------------------------------------------------
...
static void BackForwardNavigationTriggerAction_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\TriggerActions.uno");
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\DynamicLinearNavigation.uno
// ----------------------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\DirectNavigation.uno
// ---------------------------------------------------------------------------------------------
...
static void DirectNavigation_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\DirectNavigation.uno");
...
// public override sealed Fuse.Visual get_Active() :390
void DynamicLinearNavigation__get_Active_fn(DynamicLinearNavigation* __this, ::g::Fuse::Visual** __retval)
{
    return *__retval = __this->_active, void();
}

// public override sealed void set_Active(Fuse.Visual value) :391
...
// public override sealed bool get_CanGoForward() :279
...
// private void ChangeProgress(float prev, float next, Fuse.Navigation.NavigationMode mode) :261
...
// private void DirectSetActive(Fuse.Visual page) :420
...
// private void Fuse.Navigation.ISeekableNavigation.EndSeek(Fuse.Navigation.EndSeekArgs args) :465
...
// private void Fuse.Navigation.ISeekableNavigation.Seek(Fuse.Navigation.UpdateSeekArgs args) :451
void DynamicLinearNavigation__FuseNavigationISeekableNavigationSeek_fn(DynamicLinearNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Seek being called on an unrooted navigation"), __this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\DynamicLinearNavigation.uno"), 455, uString::Const("Fuse.Navigation.ISeekableNavigation.Seek"));
        return;
    }
...
// public override sealed Fuse.Navigation.NavigationPageState GetPageState(Fuse.Visual page) :267
...
// public override sealed void GoBack() :299
...
// public override sealed void GoForward() :293
...
// public override sealed void Goto(Fuse.Visual element, Fuse.Navigation.NavigationGotoMode mode) :133
void DynamicLinearNavigation__Goto_fn(DynamicLinearNavigation* __this, ::g::Fuse::Visual* element, int* mode)
{
    ...
    __this->_desiredActive = element;

    if (!__this->IsRootingCompleted())
    {
        __this->DirectSetActive(element);
        return;
    }
...
// public void GotoImpl(Fuse.Visual element, Fuse.Navigation.NavigationGotoMode mode) :156
...
// public override sealed void OnChildRemovedWhileRooted(Fuse.Node child) :353
...
// private void SetProgress(float value) :241
void DynamicLinearNavigation__SetProgress_fn(DynamicLinearNavigation* __this, float* value)
{
    __this->SetProgress(*value);
}

// private bool TransitionToChild(Fuse.Visual element, [bool bypass], [bool clamp]) :170
...
// private void UpdateDesired(Fuse.Visual target, int index) :315
...
// private void AnimationDone() [instance] :374
...
// private Fuse.Visual get_Back() [instance] :529
::g::Fuse::Visual* DynamicLinearNavigation::Back()
{
    return (PageCount() > 0) ? (::g::Fuse::Visual*)GetPage(MaxIndex()) : NULL;
}

// private void ChangeProgress(float prev, float next, Fuse.Navigation.NavigationMode mode) [instance] :261
...
// private void CheckNeedUpdate([bool off]) [instance] :197
...
// private int ClampProgress(int progress) [instance] :517
...
// private void ClearForwardHistory() [instance] :499
void DynamicLinearNavigation::ClearForwardHistory()
{
    ...
    if (HasPages() && (_active != Front()))
    {
        ...
        for (int i = target - 1; i >= 0; i--)
            ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[28/*Fuse.Node*/], NULL)), GetPage(i), &ret5);
    }

    OnHistoryChanged();
}

// private void DesiredTransition(Fuse.Visual target) [instance] :306
...
// private void DirectSetActive(Fuse.Visual page) [instance] :420
...
// private Fuse.Visual get_Front() [instance] :534
...
// public void GotoImpl(Fuse.Visual element, Fuse.Navigation.NavigationGotoMode mode) [instance] :156
void DynamicLinearNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    if (uPtr(element)->Parent() != Parent())
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Attempting to navigate to element with different parent"), element, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\DynamicLinearNavigation.uno"), 160, uString::Const("GotoImpl"), NULL);
        return;
    }
...
// private int get_MaxIndex() [instance] :524
...
void DynamicLinearNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(uString::Const("Motion should not be changed post-rooting"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\DynamicLinearNavigation.uno"), 31, uString::Const("set_Motion"), NULL);
}

// private Fuse.Visual get_Next() [instance] :544
::g::Fuse::Visual* DynamicLinearNavigation::Next()
{
    return GetPage(GetPageIndex(_active) - 1);
}

// private void OnUpdated() [instance] :216
void DynamicLinearNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Updated called without a region"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\DynamicLinearNavigation.uno"), 220, uString::Const("OnUpdated"));
        return;
    }
...
// private Fuse.Visual get_Previous() [instance] :539
::g::Fuse::Visual* DynamicLinearNavigation::Previous()
{
    return GetPage(GetPageIndex(_active) + 1);
}

// public float get_Progress() [instance] :370
...
// private void ResetRegionLimits() [instance] :235
...
// private void SetDesiredActive(Fuse.Visual page) [instance] :406
...
// private void SetProgress(float value) [instance] :241
...
// private bool TransitionToChild(Fuse.Visual element, [bool bypass], [bool clamp]) [instance] :170
...
// private void UpdateDesired(Fuse.Visual target, int index) [instance] :315
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\EdgeNavigation.uno
// -------------------------------------------------------------------------------------------
...
static void EdgeNavigation_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\EdgeNavigation.uno");
...

    {
        ...
        while (enum7.MoveNext(::TYPES[5/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]))
        {
            ...
            if (uPtr(sw.Value(::TYPES[6/*Uno.Collections.KeyValuePair<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>*/]))->Target() == page)
                return *__retval = (collection8 = uDefault< ::g::Fuse::Navigation::NavigationPageState>(), collection8.Progress = (1.0f - (float)uPtr(sw.Value(::TYPES[6/*Uno.Collections.KeyValuePair<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>*/]))->Progress()), collection8.PreviousProgress = 0.0f, collection8), void();
        }
    }
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\ExplicitNavigation.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\FindRouter.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\RouterRequest.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\RouterModify.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\Router.ScriptClass.uno
// -----------------------------------------------------------------------------------------------
...
static void RouteModificationCommand__InnerSubscription_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\ModifyRouteCommand.uno");
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\PageBinding.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\IRouterOutlet.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\Navigation.Locators.uno
// ------------------------------------------------------------------------------------------------
...
static void Navigation_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Navigation.Locators.uno");
...
void NavigationAnimation::GoProgress(double p, int variant, ::g::Fuse::Navigation::NavigationArgs* state)
{
    if (uPtr(state)->Mode() == 0)
    {
        ...
        {
            _delay = true;
            ::g::Fuse::UpdateManager::PerformNextFrame(uDelegate::New(::TYPES[12/*Uno.Action*/], (void*)NavigationAnimation__GoProgressPlay_fn, this), 0);
        }
    }
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\Navigation.Events.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\NavigationPageProxy.uno
// ------------------------------------------------------------------------------------------------
...
void NavigationPageProxy::OnPageRootingCompleted()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Got an undesired ready event"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\NavigationPageProxy.uno"), 90, uString::Const("OnPageRootingCompleted"));
        return;
    }
...
void NavigationPageProxy::RootImpl(::g::Fuse::Visual* source)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Attempting rooting to null source"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\NavigationPageProxy.uno"), 46, uString::Const("RootImpl"));
        return;
    }
    ...
    if (Page() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Unable to locate Page"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\NavigationPageProxy.uno"), 53, uString::Const("RootImpl"), NULL);
        return;
    }
    ...
    if (_navigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Something went wrong locating a Navigator"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\NavigationPageProxy.uno"), 70, uString::Const("RootImpl"));
        return;
    }
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\StructuredNavigation.uno
// -------------------------------------------------------------------------------------------------
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\PageData.uno
// -------------------------------------------------------------------------------------
...
static void PageData_build(uType* type)
{
    ...
    ::STRINGS[28] = uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\PageData.uno");
...
void PageData::AttachRouterPage(::g::Fuse::Navigation::RouterPage* rp)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[30/*"Mismatched ...*/], this, ::STRINGS[28/*"C:\\Users\\...*/], 49, ::STRINGS[29/*"AttachRoute...*/]);
        return;
    }
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\Route.uno
// ----------------------------------------------------------------------------------
...
static void Route_build(uType* type)
{
    ...
    ::STRINGS[36] = uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Route.uno");
...
Route* Route::SubDepth(int count)
{
    if (count < 0)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[35/*"count can't...*/], this, ::STRINGS[36/*"C:\\Users\\...*/], 171, ::STRINGS[37/*"SubDepth"*/]);
        return NULL;
    }
...
void Router__OnRooted_fn(Router* __this)
{
    ...
    if (uPtr(__this->_rootPage)->Node == NULL)
        ::g::Fuse::Diagnostics::UserError(uString::Const("No visual routing outlet was found"), __this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 117, ::STRINGS[10/*"OnRooted"*/], NULL);
}
...
void Router::CancelNavigation()
{
    if (_prepareOutlet != NULL)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(uString::Const("No active navigation that can be cancelled"), NULL, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 357, uString::Const("CancelNavigation"));
}
...
::g::Fuse::Navigation::Route* Router::GetRelativeRoute(::g::Fuse::Node* from, ::g::Fuse::Navigation::Route* rel)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Cannot calculate relative node if not rooted"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 642, uString::Const("GetRelativeRoute"), NULL);
        return NULL;
    }
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Did not find an outlet relative to the provided Node"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 649, uString::Const("GetRelativeRoute"), NULL);
        return NULL;
    }

    ::g::Fuse::Navigation::Route* current = GetRouteUpToRouter(uPtr(uAs< ::g::Fuse::Node*>(outlet, ::TYPES[28/*Fuse.Node*/]))->Parent());
...
void Router::Modify(int how, ::g::Fuse::Navigation::Route* route, int mode, uString* operationStyle)
{
    switch (how)
    {
        ...
        {
            if (route != NULL)
                ::g::Fuse::Diagnostics::UserWarning(uString::Const("PrepareBack does not support an explicit route"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 207, uString::Const("Modify"));

            ::g::Fuse::Navigation::Route* popRoute = GetHistoryRoute(1);

            if (popRoute == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(uString::Const("There is no history for PrepareBack"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 212, uString::Const("Modify"), NULL);
                return;
            }
...
void Router::Pop()
{
    ...
    if (route == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Cannot pop() - history is empty"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 284, uString::Const("Pop"), NULL);
        return;
    }
...
void Router::SetPrepareProgress(double value)
{
    ...
    if ((pc == NULL) || (pn == NULL))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid outlet depth in prepare progress"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 338, uString::Const("SetPrepareProgress"));
        return;
    }
...
::g::Fuse::Navigation::Route* Router::SetRoute(::g::Fuse::Navigation::Route* r, int gotoMode, int operation, uString* operationStyle, bool userRequest)
{
    ...
    if (outR == NULL)
    {
        ...
        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 378, uString::Const("SetRoute"), NULL);
        else
            ::g::Fuse::Diagnostics::InternalError(msg, this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 380, uString::Const("SetRoute"));
...
::g::Fuse::Navigation::Route* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::RouterPage* rootPage, ::g::Fuse::Navigation::Route* r, int gotoMode, int operation, uString* operationStyle, uObject** majorChange, bool canReuse)
{
    ...
    *majorChange = NULL;
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(uString::Const("No router outlet found to handle route: "), r), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 401, uString::Const("SetRouteImpl"));
        return NULL;
    }
    ...
    if (r->SubRoute != NULL)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(uString::Const("SubRoute requested but outlet has no active path: "), r), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 479, uString::Const("SetRouteImpl"));
            return NULL;
        }
...
void Router::Bookmark(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Router.bookmark` takes one argument"), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 246, uString::Const("Bookmark"), NULL);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Router.bookmark` should be passed an object"), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 253, uString::Const("Bookmark"), NULL);
        return;
    }
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        else if (::g::Uno::String::op_Equality(p, uString::Const("relative")))
        {
            ...
            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(uString::Const("Could not find an outlet from the `relative` node"), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 278, uString::Const("Bookmark"), NULL);
                return;
            }
        }
        else if (::g::Uno::String::op_Equality(p, uString::Const("path")))
        {
            ...
            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(uString::Const("`path` should be an array"), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 287, uString::Const("Bookmark"), NULL);
                return;
            }
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Unrecognized argument: "), p), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 295, uString::Const("Bookmark"), NULL);
            return;
        }
    }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("A `name` is required for the bookmark"), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 308, uString::Const("Bookmark"), NULL);
        return;
    }
...
::g::Fuse::Visual* Router::FindRouterOutletPage(::g::Fuse::Node* from)
{
    ...
    while ((from != NULL) && (uPtr(from)->Parent() != NULL))
    {
        ...
        if (ro != NULL)
        {
            ...
            ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected request for RouterOutlet page"), from, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.uno"), 560, uString::Const("FindRouterOutletPage"));
        }
...
::g::Fuse::Navigation::Route* Router::GetRelative(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() < 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.gotoRelative(): requires 1+ parameters"), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 96, uString::Const("GetRelative"), NULL);
        return NULL;
    }
...
void Router::GetRoute(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.getRoute(): must provide exactly 1 argument."), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 335, uString::Const("GetRoute"), NULL);
        return;
    }
    ...
    if (callback == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.getRoute(): argument must be a function."), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 341, uString::Const("GetRoute"), NULL);
        return;
    }

    ::g::Fuse::Navigation::Route* route = uPtr(r)->GetCurrentRoute();
    uPtr(c)->Invoke(uDelegate::New(::TYPES[12/*Uno.Action*/], (void*)Router__GetRouteCallback__Run_fn, Router__GetRouteCallback::New1(route, callback, c)));
}
...
void Router::GoBack1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.goBack takes no parameters"), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 141, uString::Const("GoBack"), NULL);
        return;
    }
...
void Router::Goto1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.goto(): invalid route provided"), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 45, uString::Const("Goto"), NULL);
}
...
void Router::Modify1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Router.modify` takes one argument"), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 184, uString::Const("Modify"), NULL);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Router.modify` should be passed an object"), r, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\Router.ScriptClass.uno"), 191, uString::Const("Modify"), NULL);
        return;
    }
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\RouterCancelNavigation.uno
// ---------------------------------------------------------------------------------------------------
...
static void RouterCancelNavigation_build(uType* type)
{
    ...
    ::STRINGS[39] = uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\RouterCancelNavigation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(8,
...
void RouterCancelNavigation__Perform_fn(RouterCancelNavigation* __this, ::g::Fuse::Node* n)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[38/*"Router not ...*/], __this, ::STRINGS[39/*"C:\\Users\\...*/], 20, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
void RouterModify::PerformRoute(::g::Fuse::Node* n, ::g::Fuse::Navigation::Route* route)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[38/*"Router not ...*/], this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\RouterModify.uno"), 211, uString::Const("PerformRoute"), NULL);
        return;
    }
...
static void RouterPage_build(uType* type)
{
    ...
    ::TYPES[27] = ::g::Fuse::Node_typeof()->MakeMethod(0/*FindBehavior<Fuse.Navigation.Router>*/, ::g::Fuse::Navigation::Router_typeof(), NULL);
    ::TYPES[8] = ::g::Fuse::Visual_typeof();
    type->SetFields(0,
...
{
    return uAs< ::g::Fuse::Visual*>(Node, ::TYPES[8/*Fuse.Visual*/]);
}
...
{
    ::g::Fuse::Navigation::Router* router = (::g::Fuse::Navigation::Router*)uPtr(at)->FindBehavior(::TYPES[27/*Fuse.Node.FindBehavior<Fuse.Navigation.Router>*/]);
...
{
    return *__retval = uAs< ::g::Fuse::Node*>(value, ::TYPES[28/*Fuse.Node*/]), void();
}
...
bool RouterRequest::AddArgument(uString* name, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Unrecognized argument: "), name), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\RouterRequest.uno"), 101, uString::Const("AddArgument"), NULL);
        return false;
    }
...
bool RouterRequest::AddPath(uObject* value)
{
    if ((_flags & 1) == 1)
    {
        ...
        if (path == NULL)
        {
            ::g::Fuse::Diagnostics::UserError(uString::Const("`path` should be an array"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\RouterRequest.uno"), 59, uString::Const("AddPath"), NULL);
            return false;
        }
...
bool RouterRequest::MakeRequest(::g::Fuse::Navigation::Router* router)
{
    ...
    if (::g::Uno::String::op_Inequality(Bookmark, NULL))
    {
        if (targetRoute != NULL)
        {
            ::g::Fuse::Diagnostics::UserError(uString::Const("A path and bookmark cannot both be specified"), router, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\RouterRequest.uno"), 116, uString::Const("MakeRequest"), NULL);
            return false;
        }

        if (!(::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(uPtr(router)->Bookmarks), Bookmark, (void**)(&targetRoute), &ret6), ret6))
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Unknown bookmark: "), Bookmark), router, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\RouterRequest.uno"), 122, uString::Const("MakeRequest"), NULL);
            return false;
        }
    }
...
bool RouterRequest::ParseNVPComponent(uObject* value, ::g::Fuse::Navigation::Route** route)
{
    ...
    ::g::Fuse::Diagnostics::UserError(uString::Const("incompatible path component"), value, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\RouterRequest.uno"), 194, uString::Const("ParseNVPComponent"), NULL);
    return false;
}
...
bool RouterRequest::ValidateParameter(uObject* arg, int depth)
{
    if (depth > 50)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Route parameter must be serializeable, it contains reference loops or is too large"), NULL, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\RouterRequest.uno"), 202, uString::Const("ValidateParameter"), NULL);
        return false;
    }
    ...
    if (uIs(arg, ::g::Fuse::Scripting::Object_typeof()))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(uString::Const("Route parameter must be serializeable, cannot contain Observables."), NULL, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\RouterRequest.uno"), 211, uString::Const("ValidateParameter"), NULL);
            return false;
        }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Route parameter must be serializeable, cannot contain functions."), NULL, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\RouterRequest.uno"), 234, uString::Const("ValidateParameter"), NULL);
        return false;
    }
...
{
    return *__retval = uAs< ::g::Fuse::Node*>(uPtr(__this->_context)->Wrap(value), ::TYPES[28/*Fuse.Node*/]), void();
}
...
void StructuredNavigation__FuseNavigationISeekableNavigationSeek_fn(StructuredNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Seek being called on an unrooted navigation"), __this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\StructuredNavigation.uno"), 408, uString::Const("Fuse.Navigation.ISeekableNavigation.Seek"));
        return;
    }
...
void StructuredNavigation__OnRooted_fn(StructuredNavigation* __this)
{
    ...
    if ((__this->_active != NULL) && !(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(uPtr(__this->Parent())->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[28/*Fuse.Node*/], NULL)), __this->_active, &ret7), ret7))
        __this->SetActive(NULL);
...
void StructuredNavigation::ClearForwardHistory()
{
    ...
    if (HasPages() && (_active != Front()))
    {
        ...
        for (int i = target - 1; i >= 0; i--)
            ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[28/*Fuse.Node*/], NULL)), GetPage(i), &ret3);
    }
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Attempting to navigate to element with different parent"), element, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\StructuredNavigation.uno"), 117, uString::Const("GotoImpl"), NULL);
        SetActive(NULL);
        return;
    }

    if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[28/*Fuse.Node*/], NULL)), element, &ret6), ret6))
    {
        if (Mode() == 1)
        {
            ClearForwardHistory();
            ::g::Uno::Collections::IList::Insert_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::g::Uno::Collections::IList_typeof()->MakeType(::TYPES[28/*Fuse.Node*/], NULL)), uCRef<int>(0), element);
        }
        else
            return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(uString::Const("Motion should not be changed post-rooting"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\StructuredNavigation.uno"), 44, uString::Const("set_Motion"), NULL);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Updated called without a region"), this, uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\StructuredNavigation.uno"), 208, uString::Const("OnUpdated"));
        return;
    }
...
static void FindRouter__Subscription_build(uType* type)
{
    ...
    ::STRINGS[44] = uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\FindRouter.uno");
...
void FindRouter__Subscription::ctor_(::g::Fuse::Navigation::FindRouter* expr, ::g::Fuse::Node* origin, uObject* listener)
{
    ...
    if (router == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"unable to f...*/], this, ::STRINGS[44/*"C:\\Users\\...*/], 49, ::STRINGS[45/*".ctor"*/], NULL);
    else
...
static void SwipeNavigate_build(uType* type)
{
    ...
    ::STRINGS[47] = uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\SwipeNavigate.uno");
    ::STRINGS[48] = uString::Const("Fuse.Input.IGesture.OnPointerPressed");
    ::TYPES[29] = ::g::Fuse::Motion::Simulation::PointerVelocity_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL);
    ::TYPES[30] = ::g::Fuse::Navigation::ISeekableNavigation_typeof();
    ::TYPES[28] = ::g::Fuse::Node_typeof();
    ::TYPES[3] = ::g::Fuse::Elements::Element_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof(),
    ...
    type->SetFields(15,
        ...
        ::TYPES[30/*Fuse.Navigation.ISeekableNavigation*/], offsetof(SwipeNavigate, _currentNavigation), 0,
        ...
        ::TYPES[29/*Fuse.Motion.Simulation.PointerVelocity<float2>*/], offsetof(SwipeNavigate, _velocity), 0,
...
void SwipeNavigate__FuseInputIGestureOnCaptureChanged_fn(SwipeNavigate* __this, ::g::Fuse::Input::PointerEventArgs* args, int* how, int* prev)
{
    ...
    {
        ::g::Fuse::Navigation::ISeekableNavigation::BeginSeek(uInterface(uPtr(__this->_currentNavigation), ::TYPES[30/*Fuse.Navigation.ISeekableNavigation*/]));
...
void SwipeNavigate__FuseInputIGestureOnLostCapture_fn(SwipeNavigate* __this, bool* forced)
{
    ...
    {
        if (uPtr(uAs< ::g::Fuse::Node*>(__this->_currentNavigation, ::TYPES[28/*Fuse.Node*/]))->IsRootingCompleted() && __this->_startedSeek)
            ::g::Fuse::Navigation::ISeekableNavigation::EndSeek(uInterface(uPtr(__this->_currentNavigation), ::TYPES[30/*Fuse.Navigation.ISeekableNavigation*/]), ::g::Fuse::Navigation::EndSeekArgs::New1(1, 0.0f));
...
void SwipeNavigate__FuseInputIGestureOnPointerMoved_fn(SwipeNavigate* __this, ::g::Fuse::Input::PointerMovedArgs* args, int* __retval)
{
    ...
    if (uPtr(__this->_gesture)->IsHardCapture())
        ::g::Fuse::Navigation::ISeekableNavigation::Seek(uInterface(uPtr(__this->_currentNavigation), ::TYPES[30/*Fuse.Navigation.ISeekableNavigation*/]), __this->GetNavigationArgs());
...
void SwipeNavigate__FuseInputIGestureOnPointerPressed_fn(SwipeNavigate* __this, ::g::Fuse::Input::PointerPressedArgs* args, int* __retval)
{
    ...
    if (__this->_currentNavigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[46/*"SwipeNaviga...*/], __this, ::STRINGS[47/*"C:\\Users\\...*/], 230, ::STRINGS[48/*"Fuse.Input....*/]);
...
void SwipeNavigate__FuseInputIGestureOnPointerReleased_fn(SwipeNavigate* __this, ::g::Fuse::Input::PointerReleasedArgs* args, int* __retval)
{
    ...
    {
        ::g::Fuse::Navigation::ISeekableNavigation::EndSeek(uInterface(uPtr(__this->_currentNavigation), ::TYPES[30/*Fuse.Navigation.ISeekableNavigation*/]), ::g::Fuse::Navigation::EndSeekArgs::New1(__this->DetermineSnap(), __this->ProgressVelocity()));
        __this->_currentNavigation = NULL;
    }
...
{
    _velocity = ((::g::Fuse::Motion::Simulation::PointerVelocity*)::g::Fuse::Motion::Simulation::PointerVelocity::New1(::TYPES[29/*Fuse.Motion.Simulation.PointerVelocity<float2>*/]));
    _forwardDirection = 1;
    _swipeAllow = 3;
    ctor_2();
...
{
    return uAs<uObject*>(::g::Fuse::Navigation::Navigation::TryFindBaseNavigation(ContextParent()), ::TYPES[30/*Fuse.Navigation.ISeekableNavigation*/]);
}
...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.3.0-rc2\VisualNavigation.uno
// ---------------------------------------------------------------------------------------------
...
static void VisualNavigation__cctor_1_fn(uType* __type)
{
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[32/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[33/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.VisualNavigation>*/], ::STRINGS[50/*"goto"*/], uDelegate::New(::TYPES[34/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.VisualNavigation, object[]>*/], (void*)VisualNavigation__gotoNode_fn), 2)));
}
...
static void VisualNavigation_build(uType* type)
{
    ...
    ::STRINGS[52] = uString::Const("C:\\Users\\Inod\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.3.0-rc2\\VisualNavigation.uno");
    ::STRINGS[53] = uString::Const("gotoNode");
    ::TYPES[31] = ::g::Uno::Type_typeof();
    ::TYPES[32] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ...
    ::TYPES[8] = ::g::Fuse::Visual_typeof();
    ::TYPES[35] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL);
    ::TYPES[36] = ::TYPES[8/*Fuse.Visual*/]->MakeMethod(2/*FirstChild<Fuse.Visual>*/, ::TYPES[8/*Fuse.Visual*/], NULL);
    ::TYPES[37] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Visual>*/, ::TYPES[8/*Fuse.Visual*/], NULL);
    ::TYPES[38] = ::g::Fuse::Navigation::ActivePageChangedHandler_typeof();
    ::TYPES[39] = ::g::Fuse::Navigation::HistoryChangedHandler_typeof();
    ::TYPES[26] = ::g::Fuse::Navigation::NavigatedHandler_typeof();
    ::TYPES[40] = ::g::Fuse::Navigation::NavigationPageCountHandler_typeof();
    ::TYPES[18] = ::g::Fuse::Navigation::NavigationHandler_typeof();
    ::TYPES[41] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL);
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof(),
        ::g::Fuse::Navigation::Navigation_typeof(),
        ::g::Fuse::Navigation::PageData_typeof());
    ...
    type->SetFields(15,
        ...
        ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Navigation::PageData_typeof(), NULL), offsetof(VisualNavigation, _pages), 0,
        ::TYPES[38/*Fuse.Navigation.ActivePageChangedHandler*/], offsetof(VisualNavigation, ActivePageChanged1), 0,
        ::TYPES[39/*Fuse.Navigation.HistoryChangedHandler*/], offsetof(VisualNavigation, HistoryChanged1), 0,
        ::TYPES[26/*Fuse.Navigation.NavigatedHandler*/], offsetof(VisualNavigation, Navigated1), 0,
        ::TYPES[40/*Fuse.Navigation.NavigationPageCountHandler*/], offsetof(VisualNavigation, PageCountChanged1), 0,
        ::TYPES[18/*Fuse.Navigation.NavigationHandler*/], offsetof(VisualNavigation, PageProgressChanged1), 0,
        ::TYPES[41/*Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>*/], offsetof(VisualNavigation, StateChanged1), 0,
...
{
    ActivePageChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ActivePageChanged1, value), ::TYPES[38/*Fuse.Navigation.ActivePageChangedHandler*/]);
}
...
{
    ActivePageChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ActivePageChanged1, value), ::TYPES[38/*Fuse.Navigation.ActivePageChangedHandler*/]);
}
...
void VisualNavigation::OnStateChanged(int newState)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(StateChanged1, NULL))
        uPtr(StateChanged1)->Invoke(2, this, (::g::Uno::UX::ValueChangedArgs__New2_fn(::TYPES[35/*Uno.UX.ValueChangedArgs<Fuse.Navigation.NavigationState>*/], uCRef<int>(newState), &ret4), ret4));
}
...
{
    StateChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(StateChanged1, value), ::TYPES[41/*Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>*/]);
}
...
{
    StateChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(StateChanged1, value), ::TYPES[41/*Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>*/]);
}
...
void VisualNavigation::UpdatePages()
{
    ...
    for (::g::Fuse::Visual* x = (::g::Fuse::Visual*)uPtr(Parent())->FirstChild(::TYPES[36/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); x != NULL; x = (::g::Fuse::Visual*)uPtr(x)->NextSibling(::TYPES[37/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
    {
...
void VisualNavigation::gotoNode(::g::Fuse::Scripting::Context* c, VisualNavigation* nav, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[51/*"Navigation....*/], nav, ::STRINGS[52/*"C:\\Users\\...*/], 30, ::STRINGS[53/*"gotoNode"*/], NULL);
}
// }
