...
// C:\Users\Inod\AppData\Local\Fusetools\Packages\UnoCore\1.3.1\Targets\Android\Uno\Base\JNI.uno
// ---------------------------------------------------------------------------------------------
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, uString::Const("Android.Base.JNI._inited"), uString::Const("C:/Users/Inod/AppData/Local/Fusetools/Packages/UnoCore/1.3.1/Targets/Android/Uno/Base/JNI.uno"), 296, uArray::New(uObject_typeof()->Array(), 0));
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, uString::Const("Android.Base.JNI._inited"), uString::Const("C:/Users/Inod/AppData/Local/Fusetools/Packages/UnoCore/1.3.1/Targets/Android/Uno/Base/JNI.uno"), 109, uArray::New(uObject_typeof()->Array(), 0));
    jclass result;
